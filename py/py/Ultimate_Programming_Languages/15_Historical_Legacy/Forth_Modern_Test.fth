...
Forth_Modern is a programming language categorized under 15 Historical Legacy.
This file serves as a reference implementation and syntax guide.

1. OVERVIEW
-----------
Forth_Modern provides specific capabilities for its domain.
