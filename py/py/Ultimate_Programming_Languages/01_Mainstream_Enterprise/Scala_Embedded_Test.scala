...
Scala_Embedded is a programming language categorized under 01 Mainstream Enterprise.
This file serves as a reference implementation and syntax guide.

1. OVERVIEW
-----------
Scala_Embedded provides specific capabilities for its domain.
