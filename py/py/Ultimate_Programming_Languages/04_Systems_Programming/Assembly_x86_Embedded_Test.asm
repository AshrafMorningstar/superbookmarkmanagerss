...
; ==========================================================================
; Language: Assembly_x86_Embedded
...
Assembly_x86_Embedded is a programming language categorized under 04 Systems Programming.
This file serves as a reference implementation and syntax guide.

1. OVERVIEW
-----------
Assembly_x86_Embedded provides specific capabilities for its domain.
