...
Cypher_Neo4j is a programming language categorized under 07 Database Query.
This file serves as a reference implementation and syntax guide.

1. OVERVIEW
-----------
Cypher_Neo4j provides specific capabilities for its domain.
